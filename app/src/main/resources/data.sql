...
(100, '0', 'Plan de Cuentas General', 'SISTEMA', 'Raíz única del catálogo contable', NULL),

-- 2. LOS TRES GRANDES GRUPOS AHORA APUNTAN A LA RAÍZ (parent_id = 100)
(1, '1', 'Activo', 'GRUPO', 'Bienes y derechos de la empresa', 100),
...
(7, '2', 'Pasivo', 'GRUPO', 'Obligaciones de la empresa', 100),
...
(11, '3', 'Patrimonio', 'GRUPO', 'Capital y resultados acumulados', 100),
